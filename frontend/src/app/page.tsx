...
export default function Home() {
  ...
  return (
    <div className="flex flex-col bg-gradient-to-br from-gray-100 to-gray-300 min-h-screen relative">
            ...
            <div className="flex-1 w-full flex flex-col items-center justify-center h-full">
              {selectedConversationId ? (
                ...
                <div className="flex flex-col items-center justify-center h-full w-full">
                  ...
                  <Input className="w-[400px] h-14 text-2xl px-6 py-4 rounded-xl border-2 border-gray-300 focus:border-blue-400 focus:ring-2 focus:ring-blue-100 transition-all" placeholder="Type a message..." />
                </div>
              )}
            </div>
          </div>
